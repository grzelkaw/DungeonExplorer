...
itemBackShot::itemBackShot(const Vector2f& position) : item(position)
{
    if (!texture.loadFromFile("resources/textures/items/backShot.png")) {
        cout << "Brak tekstury backShot";
    }
...
void itemBackShot::ifColliding(player& player, RenderWindow& window)
{
...
void itemBackShot::displayText(player& player, RenderWindow& window)
{
    Text messageText;
