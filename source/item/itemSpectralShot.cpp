...
itemSpectralShot::itemSpectralShot(const Vector2f& position) : item(position)
{
    if (!texture.loadFromFile("resources/textures/items/spectralShot.png")) {
        cout << "Brak tekstury spectralShot";
    }
...
void itemSpectralShot::ifColliding(player& player, RenderWindow& window)
{
...
void itemSpectralShot::displayText(player& player, RenderWindow& window)
{
    Text messageText;
